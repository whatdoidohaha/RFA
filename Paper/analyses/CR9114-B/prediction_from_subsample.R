...
# For analyzing this dataset, epsilon for cross-validation was set as 1e-5 instead of 1e-2.
# The strong lower bounding in this datset requires greater precision to avoid local optima.
