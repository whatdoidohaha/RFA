...
init_model <- infer_model(genotypes, y, site_combn, 0) # Good initial value required for this dataset
model <- infer_model(genotypes, y, site_combn, lambda, init_model = init_model)
