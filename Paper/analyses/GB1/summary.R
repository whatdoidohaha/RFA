...
cv_second <- identify_lambda(dir = 'cv_R2_2nd.txt', show_plot = TRUE, also_return_R2 = TRUE,
                             xlim = c(-3, 1), ylim = c(0, 1), cex = 1.6, pch = 19L)
cv_third <- identify_lambda(dir = 'cv_R2_3rd.txt', show_plot = TRUE, also_return_R2 = TRUE,
                            xlim = c(-3, 1), ylim = c(0, 1), cex = 1.6, pch = 19L)
...
plot(seq(-12, 0, by = 0.01), apply_nonspecific_epistasis(seq(-12, 0, by = 0.01), M1$nonspec_param),
     xlim = c(-12, 0), ylim = c(0, 8), type = 'l', col = 'red')
plot(s1, y, xlim = c(-12, 0), ylim = c(0, 8), pch = 16L, cex = 0.5, col = rgb(0, 0, 0, 0.2))

plot(seq(-22, 3, by = 0.01), apply_nonspecific_epistasis(seq(-22, 3, by = 0.01), M2$nonspec_param),
     xlim = c(-22, 3), ylim = c(0, 8), type = 'l', col = 'red')
plot(s2, y, xlim = c(-22, 3), ylim = c(0, 8), pch = 16L, cex = 0.5, col = rgb(0, 0, 0, 0.2))
