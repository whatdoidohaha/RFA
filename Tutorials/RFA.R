...
# a simple regression that jointly infers the reference-free effects and
# nonspecific epistasis. We then proceed to regularized regression, performing
# cross-validation to identify the optimal lasso penalty. Finally, we build
# minimal reference-free models with maximal explanatory power, which reveal the
